...
ToolsetCommon.initSelect2Compatibility = function( $ ){
	...
	// Preserve AMD loader and defaults on the wrapped function
	jQuery.fn.toolset_select2.amd = jQuery.fn.toolset_select2_original.amd;
	jQuery.fn.toolset_select2.defaults = jQuery.fn.toolset_select2_original.defaults;
};
/*
