...
Toolset_S2.define('toolset_select2/results',[
  ...
  Results.prototype.render = function () {
    var $results = $(
      '<ul class="toolset_select2-results__options" role="listbox"></ul>'
    );
...
Toolset_S2.define('toolset_select2/selection/allowClear',[
  ...
  AllowClear.prototype.update = function (decorated, data) {
    ...
    var $remove = $(
      '<span class="toolset_select2-selection__clear" title="' + removeAll() +'">' +
        '&times;' +
      '</span>'
    );
...
Toolset_S2.define('toolset_select2/selection/search',[
  ...
  Search.prototype.bind = function (decorated, container, $container) {
    ...
    this.$selection.on('click', '.toolset_select2-search--inline', function (evt) {
      if (self.$search.val()) {
        evt.stopPropagation();
      }
    });
  ...
  Search.prototype.resizeSearch = function () {
    ...
    if (this.$search.attr('placeholder') !== '') {
      width = this.$selection.find('.toolset_select2-selection__rendered').width();
    } else {
...
Toolset_S2.define('toolset_select2/dropdown/attachBody',[
  ...
  AttachBody.prototype._attachPositioningHandler =
    ...
    $watchers.each(function () {
      Utils.StoreData(this, 'toolset_select2-scroll-position', {
        x: $(this).scrollLeft(),
        y: $(this).scrollTop()
      });
    });
    ...
    $watchers.on(scrollEvent, function (ev) {
      var position = Utils.GetData(this, 'toolset_select2-scroll-position');
...
Toolset_S2.define('toolset_select2/options',[
  ...
  Options.prototype.fromElement = function ($e) {
    ...
    if (Utils.GetData($e[0], 'toolset_select2Tags')) {
      ...
      Utils.StoreData($e[0], 'data', Utils.GetData($e[0], 'toolset_select2Tags'));
...
Toolset_S2.define('toolset_select2/core',[
  ...
  var Select2 = function ($element, options) {
    if (Utils.GetData($element[0], 'toolset_select2') != null) {
      Utils.GetData($element[0], 'toolset_select2').destroy();
    }
    ...
    Utils.StoreData($element[0], 'toolset_select2', this);

    // Ensure backwards compatibility with $element.data('toolset_select2').
...
Toolset_S2.define('jquery.toolset_select2',[
  ...
  if ($.fn.toolset_select2 == null) {
    ...
    $.fn.toolset_select2 = function (options) {
      ...
      if (typeof options === 'object') {
        ...
        this.each(function () {
          var instance = Utils.GetData(this, 'toolset_select2');
  ...
  if ($.fn.toolset_select2 && $.fn.toolset_select2.defaults == null) {
